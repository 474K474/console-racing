...
void gameover() {
    ...
    PlaySoundA((LPCSTR)"C:\\GameOver.wav", NULL, SND_FILENAME | SND_ASYNC);
...
void instructions() {
    ...
    gotoxy(10, 14); cout << "When u choise option on menu write a number";
    gotoxy(10, 15); cout << "When u choise difficulty write a number & press enter";
    gotoxy(10, 17); cout << "Press any key to go back to the menu";
    _getch();
}
...
void Leader() {
    ...
    if (dif == 1) {
        ...
        gotoxy(10, 20); cout << "Press any key to go back to the menu";
        _getch();
    }
    else if (dif == 2) {
        system("cls");
...
void play() {
    ...
    PlaySoundA((LPCSTR)"C:\\Score.wav", NULL, SND_FILENAME | SND_LOOP | SND_ASYNC);
...
int main() {
    ...
    do {
        ...
        PlaySoundA((LPCSTR)"C:\\RIDE.wav", NULL, SND_FILENAME | SND_LOOP | SND_ASYNC);
